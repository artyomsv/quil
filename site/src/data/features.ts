...
export const features: Feature[] = [
  ...
  },
  {
    ...
    blurb:
      "Right-click any pane for a per-pane action menu — history, focus, notes, lazygit, rename, move to another tab, mute, attention pin, restart, close — no keybinding memorization required.",
    category: "interaction",
    detail: [
  ...
  {
    slug: "rearrange-tabs-and-panes",
    icon: "layout-panel-left",
    title: "Rearrange tabs and panes, still running",
    blurb:
      "Move a pane to another tab, a tab to another project, or re-lay-out a whole tab in one click. Nothing restarts — every process, its history and its directory stay as they were.",
    category: "interaction",
    detail: [
