...
export const plugins: PluginEntry[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Cluster connection comes from the standard kubeconfig resolution (KUBECONFIG env, then ~/.kube/config), so it lands on your current context automatically — no working-directory prompt.",
      "Read-only toggle appends --readonly so the pane can browse a cluster without exposing any mutating commands.",
      "Start-on-Pods toggle opens k9s directly on the pods view.",
