...
The ordinary MCP server exposes 36 tools. `create_from_template` requires daemon 1.74.0; older project/tab/task tools retain 1.72.0. See `docs/workspace-templates.md` and `docs/mcp.md`.
