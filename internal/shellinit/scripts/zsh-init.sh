...
(( ! ${chpwd_functions[(Ie)__quil_osc7]} )) && chpwd_functions+=(__quil_osc7)
...
(( ! ${precmd_functions[(Ie)__quil_precmd]} )) && precmd_functions=(__quil_precmd $precmd_functions)
(( ! ${precmd_functions[(Ie)__quil_osc7]} )) && precmd_functions+=(__quil_osc7)
(( ! ${preexec_functions[(Ie)__quil_preexec]} )) && preexec_functions+=(__quil_preexec)
