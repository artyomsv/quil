...
func TestSyncPaneMeta_ModelFollowsSnapshot(t *testing.T) {
	...
	syncPaneMeta(pane, &PaneInfo{ID: "p1", Model: "claude-sonnet-5", ContextTokens: 42}, false, 0, false, false)
	...
	syncPaneMeta(pane, &PaneInfo{ID: "p1", CWD: "/tmp"}, false, 0, false, false)
